...
const hash_Password = (password) => __awaiter(void 0, void 0, void 0, function* () {
    return yield bcrypt_1.default.hash(password, 10);
});
exports.hash_Password = hash_Password;
const compare_Password = (password, hashPassword) => __awaiter(void 0, void 0, void 0, function* () {
